...
function Devices() {
  ...
  useEffect(() => {
    ...
    // 🔹 Listen for signals (temp, humidity, smoke, motion, ldr)
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative flex items-center justify-between p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border border-orange-200">
                ...
                <p className={`absolute top-2 right-2 text-xs px-2 py-1 rounded font-bold ${smoke !== null ? (smoke > 600 ? "bg-red-500 text-white animate-pulse" : "bg-green-500 text-white") : ""}`}>
                  {smoke !== null ? (smoke > 600 ? "Fire" : "Normal") : ""}
                </p>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-xl border border-green-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-semibold text-slate-800">
                      {motion !== null ? (motion < 50 ? "Intruder Detected!" : "No Intruder Detected") : "—"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl border border-yellow-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-semibold text-slate-800">
                      {ldr !== null ? (ldr > 100 ? "Day-time" : "Night-time") : "—"}
                    </p>
                  </div>
                </div>
              </div>
